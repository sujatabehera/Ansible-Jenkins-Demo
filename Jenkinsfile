pipeline {
    ...
    stages {
     ...
     -D sonar.login=admin \
      ...
      -D sonar.projectBaseDir=/var/lib/jenkins/workspace/Deploy-To-Tomcat/ \
 ...
 // -Dsonar.login=241b9c6a8fb9e7ce2f06c6b6fe7816d62b9629b6 """
        ...
        stage('Deploy War file from Nexus to tomcat server using ansible') {
            ...
            steps {
               ...
               ansiblePlaybook credentialsId: 'Private-key', disableHostKeyChecking: true, extras: 'JENKINS_BUILD_NUMBER=${BUILD_NUMBER}', installation: 'Ansible', inventory: 'dev.inv', playbook: 'main.yml'
